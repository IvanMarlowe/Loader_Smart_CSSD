...
object OutputLogger {
  private var recordAccumulator = 0//ContextHelper.getSparkContext.accumulator(0, "Record Count")
  private var stageAccumulator = 0//ContextHelper.getSparkContext().accumulator(0, "Stage Id")
...
//  }
  ...
  def addLogs(transform: Transform, count: Int){
